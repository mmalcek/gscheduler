...
var file_gs_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
...
var file_gs_proto_depIdxs = []int32{
	...
	3,  // 2: gscheduler.TaskManager.AppsList:input_type -> gscheduler.Empty
	4,  // 3: gscheduler.TaskManager.TaskCreate:input_type -> gscheduler.Task
	4,  // 4: gscheduler.TaskManager.TaskUpdate:input_type -> gscheduler.Task
	6,  // 5: gscheduler.TaskManager.TaskDelete:input_type -> gscheduler.TaskUUID
	6,  // 6: gscheduler.TaskManager.TaskStop:input_type -> gscheduler.TaskUUID
	6,  // 7: gscheduler.TaskManager.TaskStart:input_type -> gscheduler.TaskUUID
	6,  // 8: gscheduler.TaskManager.TaskRun:input_type -> gscheduler.TaskUUID
	3,  // 9: gscheduler.TaskManager.TasksList:input_type -> gscheduler.Empty
	10, // 10: gscheduler.TaskManager.SchedulerStop:input_type -> gscheduler.Stop
	3,  // 11: gscheduler.TaskManager.SchedulerStart:input_type -> gscheduler.Empty
	3,  // 12: gscheduler.TaskManager.SchedulerWatch:input_type -> gscheduler.Empty
	3,  // 13: gscheduler.TaskManager.SchedulerRunningTasks:input_type -> gscheduler.Empty
	4,  // 14: gscheduler.TaskManager.ExecCmd:input_type -> gscheduler.Task
	3,  // 15: gscheduler.TaskManager.LogList:input_type -> gscheduler.Empty
	0,  // 16: gscheduler.TaskManager.LogGet:input_type -> gscheduler.Request
	1,  // 17: gscheduler.TaskManager.AppsList:output_type -> gscheduler.List
	7,  // 18: gscheduler.TaskManager.TaskCreate:output_type -> gscheduler.Status
	7,  // 19: gscheduler.TaskManager.TaskUpdate:output_type -> gscheduler.Status
	7,  // 20: gscheduler.TaskManager.TaskDelete:output_type -> gscheduler.Status
	7,  // 21: gscheduler.TaskManager.TaskStop:output_type -> gscheduler.Status
	7,  // 22: gscheduler.TaskManager.TaskStart:output_type -> gscheduler.Status
	7,  // 23: gscheduler.TaskManager.TaskRun:output_type -> gscheduler.Status
	5,  // 24: gscheduler.TaskManager.TasksList:output_type -> gscheduler.Tasks
	7,  // 25: gscheduler.TaskManager.SchedulerStop:output_type -> gscheduler.Status
	7,  // 26: gscheduler.TaskManager.SchedulerStart:output_type -> gscheduler.Status
	9,  // 27: gscheduler.TaskManager.SchedulerWatch:output_type -> gscheduler.TaskLog
	1,  // 28: gscheduler.TaskManager.SchedulerRunningTasks:output_type -> gscheduler.List
	8,  // 29: gscheduler.TaskManager.ExecCmd:output_type -> gscheduler.ExecStatus
	1,  // 30: gscheduler.TaskManager.LogList:output_type -> gscheduler.List
	2,  // 31: gscheduler.TaskManager.LogGet:output_type -> gscheduler.File
